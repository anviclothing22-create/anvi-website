...
export const instagramData: InstagramSectionData = {
  ...
  posts: [
    ...
    },
    {
      ...
      videoUrl: '/videos/reels/weaving_swarnachari.webm',
      alt: 'Handcrafted bridal couture silk kalidar ensemble',
      caption: 'Heirloom silken threads for milestone celebrations and unforgettable vows.',
      url: 'https://www.instagram.com/anviclothing_coimbatore/reels/',
      isReel: true,
      views: '48.9K',
      likes: '4.8K',
      audio: 'Bridal Shenai · Milestone Vows',
      category: 'reels',
      taggedProduct: {
